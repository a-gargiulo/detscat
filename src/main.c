...
int main(void) {
    ...
    if (!detscat_config_parser_parse(parser, &config)) {
        fprintf(stderr, "[ERROR]: While parsing '%s': %s\n", config_file, parser->error_message); 
    ...
    //         fprintf(sfile, "%22.15E %22.15E %22.15E %22.15E %22.15E %22.15E %22.15E %22.15E %22.15E %22.15E\n",
